...
// `Voice` and `OrphanedVoice` models live in Voice.swift (extracted so the
// engine layer — VoiceLoader and the headless CLI/daemon — can use them without
// VoiceManager's AVFoundation / Observation imports).
